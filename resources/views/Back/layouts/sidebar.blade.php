<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#settings-pages" role="button" aria-expanded="false" aria-controls="settings-pages">
                    <i class="link-icon" data-feather="settings"></i>
                    <span class="link-title">User profiles</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
